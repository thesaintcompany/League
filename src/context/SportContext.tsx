...
export const FOOTBALL_CATEGORIES: CategoryOption[] = [
  { id: "all", name: "Toate", shortName: "Toate", icon: "public" },
  { id: "masculin", name: "Masculin (Seniori)", shortName: "Masculin", icon: "male" },
  { id: "feminin", name: "Feminin", shortName: "Feminin", icon: "female" },
  { id: "futsal", name: "Futsal / Sală", shortName: "Futsal", icon: "sports_soccer" },
  { id: "juniori", name: "Juniori & Tineret", shortName: "Juniori", icon: "child_friendly" },
];

export const TENNIS_CATEGORIES_OPTIONS: CategoryOption[] = [
  { id: "all", name: "Toate Categoriile", shortName: "Toate", icon: "public" },
  { id: "simplu_masculin", name: "Simplu Masculin", shortName: "Simplu M", icon: "sports_tennis" },
  { id: "simplu_feminin", name: "Simplu Feminin", shortName: "Simplu F", icon: "sports_tennis" },
  { id: "dublu_masculin", name: "Dublu Masculin", shortName: "Dublu M", icon: "groups_2" },
  { id: "dublu_mixt", name: "Dublu Mixt", shortName: "Dublu Mixt", icon: "diversity_2" },
];

export const PADEL_CATEGORIES_OPTIONS: CategoryOption[] = [
  { id: "all", name: "Toate Categoriile", shortName: "Toate", icon: "public" },
  { id: "padel_masculin", name: "Dublu Masculin", shortName: "Dublu M", icon: "groups_2" },
  { id: "padel_feminin", name: "Dublu Feminin", shortName: "Dublu F", icon: "groups_2" },
  { id: "padel_mixt", name: "Dublu Mixt", shortName: "Dublu Mixt", icon: "diversity_2" },
  { id: "padel_pro", name: "Nivel Pro", shortName: "Pro", icon: "star" },
  { id: "padel_amatori", name: "Nivel Amatori", shortName: "Amatori", icon: "star" },
];

export const PINGPONG_CATEGORIES_OPTIONS: CategoryOption[] = [
  { id: "all", name: "Toate Categoriile", shortName: "Toate", icon: "public" },
  { id: "pingpong_simplu_masculin", name: "Simplu Masculin", shortName: "Simplu M", icon: "sports_tennis" },
  { id: "pingpong_simplu_feminin", name: "Simplu Feminin", shortName: "Simplu F", icon: "sports_tennis" },
