            ...
            {activeMatch?.status === "finished" || activeMatch?.status === "cancelled" ? (
              ...
              <>
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <a
                    href={`https://api.whatsapp.com/send?text=${encodeURIComponent(` Link Scanner Porți Meci ${activeMatch?.homeTeam.name} vs ${activeMatch?.awayTeam.name}: https://ligue.ro/tickets/scanner?matchId=${activeMatch?.id}&token=${activeMatch?.gateAccessSecret || "SECRET"}`)}`}
                    target="_blank"
                    rel="noreferrer"
