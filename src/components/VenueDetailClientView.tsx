              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/30 to-transparent flex flex-col justify-end p-5 text-white">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="px-2 py-0.5 rounded-full bg-lime-400 text-slate-950 font-black text-[9px] uppercase font-mono">
                      Foto #{idx + 1}
                    </span>
                      ...
                      <div className="flex items-center gap-2">
                        {!isTicketSalesClosed(m) ? (
                          <Link
                            ...
                            className="flex-1 sm:flex-initial px-4 py-2 rounded-xl bg-lime-400 hover:bg-lime-300 text-slate-950 font-bold text-xs uppercase tracking-wider transition shadow-sm flex items-center justify-center gap-1.5 active:scale-95"
                          >
