            ...
            <div className="flex items-center gap-1.5">
              {activeCategories && activeCategories.length > 1 && (
                <button
                  type="button"
                  onClick={toggleCategories}
                  className={`px-2 py-0.5 rounded-lg text-[10px] sm:text-[11px] font-headline font-bold uppercase tracking-wider transition border flex items-center gap-1 shrink-0 shadow-sm ${
                    showCategories
                      ? "bg-slate-900 text-white dark:bg-slate-800 dark:text-white border-slate-700"
                      : isCustomCategoryActive
                      ? "bg-lime-400 text-slate-950 border-lime-400 font-black"
                ...
                >
                  ...
                  <span>{showCategories ? "Ascunde" : "Categorii"}</span>
                </button>
              )}
