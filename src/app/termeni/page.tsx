      ...
      <section className="relative overflow-hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10">
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
            Ultima actualizare: Sezon 2026 • Operat   de <strong>   ligue.ro</strong>
          </p>
        </div>
      </section>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-1 w-full">
        <div className="card p-8 sm:p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl space-y-8 shadow-sm text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          <section className="space-y-2">
            ...
            <p>
              Prin accesarea și utilizarea platformei <strong>PRO LIGUE</strong> (disponibilă pe domeniile  e operate de    ligue.ro), confirmați că ați citit, înțeles și sunteți de acord să respectați acești Termeni și Condiții, precum și toate legile și reglementările românești aplicabile.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Toate mărcile, siglele (inclusiv sigla  ă PRO LIGUE ROMANIA), denumirile de arene, elementele grafice și codul sursă aparțin exclusiv <strong>   ligue.ro</strong> și partenerilor afiliați. Este interzisă reproducerea neautorizată.
            </p>
          </section>
