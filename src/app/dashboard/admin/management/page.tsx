  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white flex font-body transition-colors duration-200">
      ...
      <div className="flex-1 lg:ml-64 ml-0 flex flex-col min-w-0">
        <TopHeader
          title="Consolă SuperAdministrator • Gestiune Campionate & Echipe"
          subtitle="Control total asupra tuturor competițiilor, turneelor, cluburilor sportive, loturilor de jucători și stărilor pe întreaga platformă"
        />
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-slate-500 dark:text-slate-400 font-label">
                  PRO LIGUE • Administrare Națională Competiții &amp; Cluburi
                </span>
              </div>
              <h1 className="text-2xl sm:text-3xl font-black italic tracking-tight font-headline uppercase text-slate-900 dark:text-white mt-1">
                Administrare Campionate &amp; Echipe
              </h1>
            </div>
