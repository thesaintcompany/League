  ...
  try {
    ...
    const updated = await prisma.systemSetting.upsert({
      ...
      update: {
        ...
        emailGatewayEnabled:
          body.emailGatewayEnabled !== undefined ? Boolean(body.emailGatewayEnabled) : undefined,
        emailProvider: body.emailProvider !== undefined ? body.emailProvider : undefined,
        emailSenderEmail: body.emailSenderEmail !== undefined ? body.emailSenderEmail : undefined,
        emailSenderName: body.emailSenderName !== undefined ? body.emailSenderName : undefined,
        emailReplyTo: body.emailReplyTo !== undefined ? body.emailReplyTo : undefined,
        emailSmtpHost: body.emailSmtpHost !== undefined ? body.emailSmtpHost : undefined,
        emailSmtpPort: typeof body.emailSmtpPort === "number" ? body.emailSmtpPort : undefined,
        emailSmtpSecure: body.emailSmtpSecure !== undefined ? Boolean(body.emailSmtpSecure) : undefined,
        emailSmtpUser: body.emailSmtpUser !== undefined ? body.emailSmtpUser : undefined,
        emailSmtpPass: body.emailSmtpPass !== undefined ? body.emailSmtpPass : undefined,
        emailZeptoToken: body.emailZeptoToken !== undefined ? body.emailZeptoToken : undefined,
        emailZeptoRegion: body.emailZeptoRegion !== undefined ? body.emailZeptoRegion : undefined,
        emailSendmailPath: body.emailSendmailPath !== undefined ? body.emailSendmailPath : undefined,
      },
      create: {
        id: "default",
